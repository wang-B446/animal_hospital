    ...
    <el-card shadow="never" style="margin-bottom: 20px">
      <el-row :gutter="20" align="middle">
        ...
        <el-col :span="14" style="text-align: right">
          <el-button type="success" @click="handleAdd">新增主人</el-button>
        </el-col>
      </el-row>
    </el-card>
...
const loadData = async () => {
  const res = await request.get('/owner/page', {
...
const handleSearch = async () => {
  ...
  const res = await request.get('/owner/search/page', {
...
const handleSubmit = async () => {
  ...
  if (form.value.id) {
    await request.put('/owner', form.value)
...
const handleDelete = (id) => {
  ElMessageBox.confirm('确定删除该主人记录吗？', '提示', { type: 'warning' }).then(async () => {
